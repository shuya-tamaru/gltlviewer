  ...
  return (
    <>
      ...
      <Flex>
          ...
          <SimpleGrid w="100%" h="92%" columns={3} spacing={10} overflowY="scroll" py="5" px="5">
            {posts.map((post) => (
              <Link href="/comments/commentDetail">
                <Box cursor="pointer" key={post} h="300px" overflow="hidden"  boxShadow="dark-lg" borderRadius="3" p="3">
                  <Post/>
                </Box>
              </Link>
            ))}
        ...
        <Box w="20%" h="calc(100vh - 80px)" boxShadow="2xl" display="flex" flexDirection="column" alignItems="center" pt="5">
          <CommentSearchForm/>
        </Box>
      </Flex>
    </>
